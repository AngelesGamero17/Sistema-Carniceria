...
<li class="nav-item">
    ...
    <center>
      <br>
                  <div class="container"  style="background-color:#FCDBDA;">
                            ...
                            <thead>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <a class="navbar-brand" href="{{route('Orders.edit',$order->id)}}"> <center><b>Editar</b>
           ...
           <div class="col-md-4 offset-md-4">
            <div class="d-grid mx-auto">
                ...
                <a class="navbar-brand" href="{{route('Orders.create')}}"> <b>Crear</b>  
                </a>
