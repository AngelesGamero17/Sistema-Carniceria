...
@csrf
  ...
  <div class="mb-3">
    <label for="exampleInputEmail1"  class="form-label">Id Condition</label>
    <input type="text" name="id_condition" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
    <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div>
  </div>
...
<div class="row mt-3">
           <div class="col-md-4 offset-md-4">
            ...
            <a href="{{route('Products.index')}}" class="fa-solid fa-cicle-plus"">Lista de Productos</a>
